...
import { CheckCircle, AlertTriangle, AlertCircle, Phone, Calendar, MessageSquare } from 'lucide-react';
...
export default function ResultsPage() {
  ...
  const results: RAGResults = {
    green: {
      ...
      message: triageData?.reasoning || 'Based on your responses, your symptoms appear to be mild and manageable with self-care.',
      advice: triageData?.advice
        ? parseAdvice(triageData.advice)
        : [
      ...
      followUp: {
        show: triageData?.followUpRequired ?? false,
    ...
    amber: {
      ...
      message: triageData?.reasoning || 'Your symptoms require professional assessment, though they don&apos;t appear immediately life-threatening.',
      advice: triageData?.advice
        ? parseAdvice(triageData.advice)
        : [
    ...
    red: {
      ...
      message: triageData?.reasoning || 'Your symptoms may indicate a serious condition requiring emergency care.',
      advice: triageData?.advice
        ? parseAdvice(triageData.advice)
        : [
      ...
      emergencyCode: triageData?.emergencyCode,
      followUp: {
        show: false,
      },
      action: {
            ...
            {triageData?.possibleDiagnosis && (
              <div className='p-6 bg-gray-50 border-b border-gray-200'>
                ...
                <p className='text-sm text-gray-500 mt-3 italic'>
                  ⚠️ This is not a medical diagnosis. Only a qualified healthcare professional can diagnose your condition.
                </p>
              </div>
            )}
            ...
            {activeTab === 'red' && current.emergencyCode && (
              <div className='p-6 bg-gray-50 border-t border-gray-200'>
                ...
                <p className='text-sm text-gray-600 mt-3'>
                  ...
                  <span className='font-mono bg-gray-200 px-2 py-1 rounded ml-1'>illness.ai/emergency/{current.emergencyCode}</span>
                </p>
              </div>
            )}
                ...
                <div className='flex items-start'>
                  ...
                  <div>
                    ...
                    <p className='text-sm text-blue-600 mt-2'>
                      Reply YES if improved, NO if symptoms worsen (we&apos;ll escalate to AMBER/RED if needed)
                    </p>
                  </div>
                </div>
              </div>
